# NAME: Lovissa Price
#PROG-PURPOSE: Read in a list of costumers and display a report that will
...
def read_in_cust_file():
    ...
    #split the data inro a list of individual customer lists
